...
function draw() {
  if(score===1){
    ...
    stroke("black")
      ...
      strokeWeight(4)
      text("CONGRTULATIONS YOU ARE A REAL EARTH SAVIOUR",110,height/2)
  ...
  //playbutton.visible=true
    ...
    pause.visible=true
     ...
     text("LEVEL 1",width/5,100)
         ...
         text("You have to collect 15 water droplets to move to the NEXT LEVEL ",100,height/2.5+250)
...
function levelstart2(){
  ...
  text("LEVEL 2",width/5,100)
      ...
      text("You have to remove 15 pollutants to WIN the GAME ",100,height/2.5+250)
      text("GO GET IT !",width/2,height/2.5+300)
